    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 shadow-xl relative overflow-hidden group hover:border-slate-700 transition-all">
        ...
        <div className="flex items-baseline gap-2">
          <h2 className={`text-2xl font-bold tracking-tight ${summary.netBalance >= 0 ? 'text-white' : 'text-rose-400'}`}>
            {formatCurrency(summary.netBalance)}
          </h2>
        </div>
        <p className="text-xs text-slate-500 mt-2 flex items-center gap-1">
          <span>Overall net wealth standing</span>
        </p>
      ...
      <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 shadow-xl relative overflow-hidden group hover:border-slate-700 transition-all">
        ...
        <div className="flex items-baseline justify-between">
          ...
          <span className="text-xs font-medium text-emerald-400/90 bg-emerald-500/10 px-2 py-0.5 rounded-md flex items-center">
      ...
      <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 shadow-xl relative overflow-hidden group hover:border-slate-700 transition-all">
        ...
        <div className="flex items-baseline justify-between">
          ...
          <span className="text-xs font-medium text-rose-400/90 bg-rose-500/10 px-2 py-0.5 rounded-md flex items-center">
      ...
      <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 shadow-xl relative overflow-hidden group hover:border-slate-700 transition-all">
        ...
        <div className="flex items-baseline justify-between">
          <h2 className="text-2xl font-bold tracking-tight text-violet-300">
